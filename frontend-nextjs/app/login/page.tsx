  ...
  return (
    <div className="relative min-h-screen flex overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
        ...
        {/* Background Logo - Dark Background with Stars */}
        <div className="absolute inset-0 flex items-center justify-center opacity-25 pointer-events-none">
          <img
            ...
            style={{
              transform: mounted ? `translate(${parallaxX * -0.3}px, ${parallaxY * -0.3}px) scale(1.2)` : 'translate(0, 0) scale(1.2)',
              transition: mounted ? 'transform 0.3s ease-out' : 'none',
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative lg:px-12">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Username */}
            <div className="group">
              <label htmlFor="username" className="block text-sm font-bold text-slate-700 mb-2.5">
                ユーザー名
              </label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-slate-400 group-focus-within:text-blue-600 transition-colors duration-200">
                ...
                <input
                  ...
                  className="w-full pl-13 pr-4 py-4 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all duration-200 bg-white/80 backdrop-blur-sm text-slate-900 placeholder-slate-400 font-medium shadow-sm hover:border-slate-300"
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-13 pr-14 py-4 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all duration-200 bg-white/80 backdrop-blur-sm text-slate-900 placeholder-slate-400 font-medium shadow-sm hover:border-slate-300"
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-blue-600 transition-colors duration-200 p-1"
                >
                  {showPassword ? (
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2.5 text-sm font-medium text-slate-700 cursor-pointer select-none">
                  ログイン状態を保持
                </label>
              </div>
              <a href="#" className="text-sm font-bold text-blue-600 hover:text-blue-700 transition-colors duration-200">
                パスワードを忘れた場合
              </a>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="group relative w-full py-4 px-6 bg-gradient-to-r from-blue-600 via-blue-600 to-indigo-600 text-white font-bold rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 hover:from-blue-700 hover:via-blue-700 hover:to-indigo-700 transform hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none overflow-hidden"
            >
              {/* Shimmer effect */}
